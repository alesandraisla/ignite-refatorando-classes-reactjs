...
export function Dashboard() {
    ...
    async function handleUpdateFood(food: FoodDataType): Promise<void> {
        try {
            const foodUpdated = await api.put(`/foods/${editingFood.id}`, {
                    ...editingFood,
                    ...food,
                });
            const foodsUpdated = foods.map((forFood) => 
                    forFood.id !== foodUpdated.data.id ? forFood : foodUpdated.data,
            );
